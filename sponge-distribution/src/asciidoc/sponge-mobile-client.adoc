...
|`IconInfo` or `String`
|Action
|An action icon. The icon feature converter supports an instance of `IconInfo` or `String` (an icon name) as a value. The supported set of icon names is limited to the https://cdn.materialdesignicons.com/5.3.45/[material design icons (currently v5.3.45)].
