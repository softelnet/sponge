...
_There is also a draft of an additional, experimental functionality that will allow users to subscribe to {sponge} events in the mobile application. In case of a new event a notification will be displayed. The subscribed events will be shown in the list. By tapping on an event the user will be directed to a screen presenting an action associated with this event._
