...
|`engine`
|`sponge-kb-engine`
|The Engine Knowledge Base artifact provides `engine_admin_library.py` and `engine_public_library.py` script files that define actions related to {sponge} engine, e.g. `EngineReload`, `EngineGetVersion`.
