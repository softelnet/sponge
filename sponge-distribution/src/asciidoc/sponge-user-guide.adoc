...
|`Object onCall(args)`
|The callback method invoked when an action is called, e.g.: `EPS.call()`. The argument in an array of `Object's` and the result is an `Object`. This method is mandatory.
|===
