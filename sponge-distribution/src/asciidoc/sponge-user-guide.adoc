...
*** *Correlators* - event set processors that detect any set of events and could be also used to implement any complex event processing that isn't provided by filters, triggers or rules.
