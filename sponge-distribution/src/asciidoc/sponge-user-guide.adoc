...
ObjectType("org.openksavi.sponge.examples.TestCompoundComplexObject").tag("complex")
ListType(ObjectType("org.openksavi.sponge.examples.TestCompoundComplexObject"))
