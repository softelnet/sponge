...
* Added `ProvidedMeta.optional` - a flag specifying if a provided read is optional, i.e. a value may be provided implicitly, for example when other value is submitted.
