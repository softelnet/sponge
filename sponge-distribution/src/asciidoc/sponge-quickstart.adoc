...
class HelloWorldAction(Action): # <1>
    def onConfigure(self): # <2>
        ...
        self.argsMeta = [ArgMeta("name", StringType()).label("Your name").description("Type your name.")] # <4>
        self.resultMeta = ResultMeta(StringType()).label("Greeting").description("The greeting text.") # <5>
...
class HelloWorldAction < Action # <1>
    def onConfigure # <2>
        self.label = "Hello world" # <3>
        self.description = "Returns a greeting text."
        self.argsMeta = [ArgMeta.new("name", StringType.new()).label("Your name").description("Type your name.")] # <4>
        self.resultMeta = ResultMeta.new(StringType.new()).label("Greeting").description("The greeting text.") # <5>
    end
    def onCall(name) # <6>
...
class HelloWorldAction extends Action { // <1>
    void onConfigure() { // <2>
        ...
        this.argsMeta = [new ArgMeta("name", new StringType()).label("Your name").description("Type your name.")] // <4>
        this.resultMeta = new ResultMeta(new StringType()).label("Greeting").description("The greeting text.") // <5>
    }
...
var HelloWorldAction = Java.extend(Action, { // <1>
    onConfigure: function(self) { // <2>
        self.label = "Hello world"; // <3>
        self.description = "Returns a greeting text.";
        self.argsMeta = [new ArgMeta("name", new StringType()).label("Your name").description("Type your name.")]; // <4>
        self.resultMeta = new ResultMeta(new StringType()).label("Greeting").description("The greeting text."); // <5>
    },
