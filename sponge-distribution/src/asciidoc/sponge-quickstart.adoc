...
The standalone command-line program may also be run as a https://www.docker.com[Docker] container.

.Invoke {sponge} in an interactive mode with the Python interpreter in a Docker container
[source,bash,subs="verbatim,attributes"]
----
