...
==== Interactive mode
The {sponge} standalone command-line program can be invoked in the interactive (https://en.wikipedia.org/wiki/Read–eval–print_loop[REPL]) mode, providing command-line access to the knowledge base interpreter.
