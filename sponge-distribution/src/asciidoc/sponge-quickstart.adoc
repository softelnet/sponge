...
Correlator:: Correlators detect correlations between events and could also be used to implement any complex event processing that isn't provided by filters, triggers or rules.
****
