...
== Correlators
Correlators are a generalized form of rules. Internally rules and correlators are two types of vent set processors. Correlators are used to implement any complex event processing that isn't provided by filters, triggers or rules.
