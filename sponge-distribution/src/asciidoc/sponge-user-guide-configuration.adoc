...
|`eventSchedulerThreadCount`
|The number of threads used by the Event Scheduler to generate and send scheduled events. In most cases there should be no need to change this parameter, because generating and sending a new event is fast.
|`1`
