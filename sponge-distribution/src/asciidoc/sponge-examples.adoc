...
:exampleName: actions
include::includes/sponge-example-script.adoc[]
...
[source,xml]
----
include::{rootDir}/sponge-jython/examples/script/py/events_clone_policy.xml[]
----
...
[source,xml]
----
include::{rootDir}/sponge-jython/examples/script/py/hello_world.xml[]
----
...
:exampleName: knowledge_base_library
include::includes/sponge-example-script.adoc[]
...
[source,xml]
----
include::{rootDir}/sponge-jython/examples/script/py/knowledge_base_library.xml[]
----
...
[source,xml]
----
include::{rootDir}/sponge-jython/examples/script/py/plugins_java.xml[]
----
...
[source,xml]
----
include::{rootDir}/sponge-jython/examples/script/py/plugins_script.xml[]
----
...
[source,xml]
----
include::{rootDir}/sponge-jython/examples/script/py/rules_events.xml[]
----
...
[source,xml]
----
include::{rootDir}/sponge-jython/examples/script/py/triggers.xml[]
----
...
[source,python]
----
include::{rootDir}/sponge-integration-tests/examples/core/fibonacci.py[]
----
...
[source,xml]
----
include::{rootDir}/sponge-integration-tests/examples/core/engine_parameters.xml[]
----
...
[source,python]
----
include::{rootDir}/sponge-spring/examples/spring/spring.py[]
----
...
[source,java]
----
include::{rootDir}/sponge-spring/src/test/java/org/openksavi/sponge/spring/test/SpringTest.java[]
----
...
[source,python]
----
include::{rootDir}/sponge-camel/examples/camel/camel_rss.py[]
----
...
[source,java]
----
include::{rootDir}/sponge-camel/src/test/java/org/openksavi/sponge/camel/test/CamelRssTest.java[]
----
...
[source,python]
----
include::{rootDir}/sponge-camel/examples/camel/camel_producer.py[]
----
...
[source,java]
----
include::{rootDir}/sponge-camel/src/test/java/org/openksavi/sponge/camel/test/SimpleCamelProducerTest.java[]
----
...
[source,python]
----
include::{rootDir}/sponge-camel/examples/camel/camel_consumer.py[]
----
...
[source,java]
----
include::{rootDir}/sponge-camel/src/test/java/org/openksavi/sponge/camel/test/SimpleCamelConsumerTest.java[]
----
...
[source,python]
----
include::{rootDir}/sponge-camel/examples/camel/camel_producer_overridden_action.py[]
----
...
[source,java]
----
include::{rootDir}/sponge-camel/src/test/java/org/openksavi/sponge/camel/test/CamelProducerOverriddenActionTest.java[]
----
...
[source,python]
----
include::{rootDir}/sponge-camel/examples/camel/camel_producer_custom_action.py[]
----
...
[source,java]
----
include::{rootDir}/sponge-camel/src/test/java/org/openksavi/sponge/camel/test/CamelProducerCustomActionTest.java[]
----
...
[source,python]
----
include::{rootDir}/sponge-camel/examples/camel/camel_multiple_consumer.py[]
----
...
[source,java]
----
include::{rootDir}/sponge-camel/src/test/java/org/openksavi/sponge/camel/test/CamelMultipleConsumerTest.java[]
----
