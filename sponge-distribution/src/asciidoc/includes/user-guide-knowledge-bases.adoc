...
The `spar` protocol name is an acronym for *SP*onge *AR*chive. The `spar` protocol accepts wildcards in an archive content path but not in an archive file path itself.
