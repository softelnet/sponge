...
There is also the implementation that uses the Spring (version 5) RestTemplate: `SpringSpongeRestClient`.
...
In case of using `SpringSpongeRestClient` you should also add the following dependency to your `pom.xml`:
