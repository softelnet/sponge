...
* Connect to a {sponge} service via the *Sponge Remote mobile application* (currently under development) or a custom mobile app build with the *Sponge Flutter API* (currently under development).
