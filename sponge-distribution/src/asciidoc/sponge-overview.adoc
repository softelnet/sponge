...
* Allows *publishing a custom Remote API of your application as a set of actions (e.g. written in a scripting language) that may be changed and reloaded on the fly*.
