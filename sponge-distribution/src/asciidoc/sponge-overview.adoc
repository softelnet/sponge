...
* supports connecting with many types of external systems by integration with http://camel.apache.org[Apache Camel],
...
____
Softelnet has for may years used Open Source Software in its commercial products. Therefore we appreciate the impact of Open Source on the development of IT world and believe that its constant development is important. In order to contribute to the Open Source community we share and maintain projects such as Sponge.
____
