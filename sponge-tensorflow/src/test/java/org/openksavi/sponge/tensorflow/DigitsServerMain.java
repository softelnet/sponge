...
public class DigitsServerMain {
    ...
    public static class Config extends SpongeCamelConfiguration {
        ...
        public SpongeEngine spongeEngine() {
            return SpringSpongeEngine.builder().plugins(camelPlugin()).config("examples/tensorflow/digits/digits_remote_server.xml").build();
        }
    }
