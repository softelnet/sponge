 ...
 */
public class JavaKnowledgeBaseInterpreterFactory implements KnowledgeBaseInterpreterFactory {

    @Override
    public KnowledgeBaseType getSupportedType() {
        return JavaKnowledgeBaseInterpreter.TYPE;
    }

    @Override
    public KnowledgeBaseInterpreter createKnowledgeBaseInterpreter(Engine engine, KnowledgeBase knowledgeBase) {
        return new JavaKnowledgeBaseInterpreter(engine, knowledgeBase);
    }
}
