...
public class StandaloneErrorReportingTest {
    ...
    public static void beforeClass() {
        ...
        TestUtils.reloadLogback("../sponge-distribution/src/release/logback.xml");
    }

    @AfterClass
    public static void afterClass() {
        System.clearProperty(ConfigurationConstants.PROP_HOME);
        TestUtils.reloadLogback("../sponge-examples/src/test/resources/logback.xml");
    }
    ...
    protected void testErrorReporting(String name, KnowledgeBaseType type) {
        ...
        try {
            ...
            engineMain = TestUtils.startupStandaloneEngineMain(args.toArray(new String[args.size()]));
