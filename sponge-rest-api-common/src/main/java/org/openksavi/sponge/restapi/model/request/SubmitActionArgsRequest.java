...
@ApiModel(value = "SubmitActionArgsRequest", description = "A submit action arguments request")
public class SubmitActionArgsRequest extends SpongeRequest implements ActionExecutionRequest {
    ...
    public SubmitActionArgsRequest() {
    }

    public SubmitActionArgsRequest(String name, List<String> argNames, Map<String, Object> current,
    ...
    @ApiModelProperty(value = "The names of submitted action arguments", required = false)
