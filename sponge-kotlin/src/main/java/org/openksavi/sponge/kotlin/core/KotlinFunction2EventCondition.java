...
/**
 * Kotlin Function2 rule event condition.
 */
public class KotlinFunction2EventCondition implements EventCondition {

    private Function2<Rule, Event, Boolean> function;
     ...
     *
     */
    public KotlinFunction2EventCondition(Function2<Rule, Event, Boolean> function) {
    ...
    public boolean condition(Rule rule, Event event) {
        return function.invoke(rule, event);
    }
}
