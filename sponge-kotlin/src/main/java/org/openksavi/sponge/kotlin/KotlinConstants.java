...
public final class KotlinConstants {
    ...
    public static final Map<Class, Class> PROCESSOR_CLASSES = SpongeUtils.immutableMapOf(
            Action.class, KotlinAction.class,
            Filter.class, KotlinFilter.class,
            Trigger.class, KotlinTrigger.class,
            Rule.class, KotlinRule.class,
            Correlator.class, KotlinCorrelator.class
            );
    //@formatter:on
