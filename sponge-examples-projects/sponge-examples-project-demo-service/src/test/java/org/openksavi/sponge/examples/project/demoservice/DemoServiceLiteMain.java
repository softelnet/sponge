...
public class DemoServiceLiteMain {

    // TODO Standalone
    public static void main(String... args) {
        System.setProperty(ConfigurationConstants.PROP_HOME, "sponge");
        System.setProperty(DemoServiceTestEnvironment.PROPERTY_PASSWORD_FILE, "password.txt");

        // StandaloneEngineMain engineMain = new StandaloneEngineMain(true);
        // engineMain.startup("-c", "sponge/sponge-lite.xml");
    }
}
