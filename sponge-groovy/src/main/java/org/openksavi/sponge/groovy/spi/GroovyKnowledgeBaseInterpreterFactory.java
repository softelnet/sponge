...
import org.openksavi.sponge.groovy.core.GroovyKnowledgeBaseInterpreter;
...
/**
 * Groovy-based knowledge base interpreter factory.
 */
public class GroovyKnowledgeBaseInterpreterFactory implements KnowledgeBaseInterpreterFactory {

    @Override
    public KnowledgeBaseType getSupportedType() {
        return GroovyConstants.TYPE;
    }
