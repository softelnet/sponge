...
public class GetFeaturesRequest extends TypedParamsRequest<BaseRequestParams> {

    public GetFeaturesRequest(BaseRequestParams params) {
        super(RemoteApiConstants.METHOD_FEATURES, params);
    }
