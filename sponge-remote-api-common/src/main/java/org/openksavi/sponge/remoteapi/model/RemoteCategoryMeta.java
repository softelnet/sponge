...
public class RemoteCategoryMeta implements Descriptive, HasFeatures {
    ...
    public RemoteCategoryMeta() {
    }

    public RemoteCategoryMeta(String name, String label, String description, Map<String, Object> features, Integer sequenceNumber) {
        this.name = name;
        this.label = label;
