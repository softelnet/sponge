...
public class ReloadRequest extends TypedParamsRequest<BaseRequestParams> {

    public ReloadRequest(BaseRequestParams params) {
        super(RemoteApiConstants.METHOD_RELOAD, params);
    }
