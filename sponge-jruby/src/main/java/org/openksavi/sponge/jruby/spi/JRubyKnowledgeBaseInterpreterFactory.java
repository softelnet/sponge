...
/**
 * JRuby-based knowledge base interpreter factory.
 */
public class JRubyKnowledgeBaseInterpreterFactory implements KnowledgeBaseInterpreterFactory {

    @Override
    public KnowledgeBaseType getSupportedType() {
        return RubyConstants.TYPE;
    }
