...
public class OkHttpHttpsRemoteApiTest extends BaseHttpsRemoteApiTest {

    @Override
    protected SpongeClient createClient() {
        return new OkHttpSpongeClient(SpongeClientConfiguration.builder().url(String.format("https://localhost:%d", port)).build(),
