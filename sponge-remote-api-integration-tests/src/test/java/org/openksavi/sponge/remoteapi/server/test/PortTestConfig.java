...
public class PortTestConfig extends SpongeCamelConfiguration {
    ...
    public static final String PORT_BEAN_NAME = "spongeRemoteApiPort";

    @Bean(name = PORT_BEAN_NAME)
    public Integer spongeRemoteApiPort() {
        return TestUtils.findAvailablePairOfNeighbouringTcpPorts();
    }
}
