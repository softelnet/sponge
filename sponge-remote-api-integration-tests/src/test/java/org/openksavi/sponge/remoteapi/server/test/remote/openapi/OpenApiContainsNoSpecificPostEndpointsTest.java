...
@ContextConfiguration(classes = { OpenApiContainsNoSpecificPostEndpointsTest.TestConfig.class })
public class OpenApiContainsNoSpecificPostEndpointsTest extends BaseOpenApiTest {
    ...
    @Test
    public void shouldContainNoSpecificPostEndpoints() throws IOException {
        ...
        RemoteApiTestUtils.assertOpenApiHasEndpoint(docs, RemoteApiConstants.METHOD_FEATURES, false);
        ...
        RemoteApiTestUtils.assertOpenApiHasEndpoint(docs, RemoteApiConstants.METHOD_LOGIN, false);
