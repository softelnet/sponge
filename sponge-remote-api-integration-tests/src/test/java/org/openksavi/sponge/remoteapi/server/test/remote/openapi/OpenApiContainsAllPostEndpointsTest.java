...
@ContextConfiguration(classes = { OpenApiContainsAllPostEndpointsTest.TestConfig.class })
public class OpenApiContainsAllPostEndpointsTest extends BaseOpenApiTest {
    ...
    @Test
    public void shouldOpenApiContainAllPostEndpoints() throws IOException {
